...
<div style="background: grey; display:flex; border:3px solid black; flex-direction:row; flex-wrap: wrap">
...
<div style="background: grey; display:flex; border:3px solid black; flex-direction:row; flex-wrap: wrap-reverse">
  <div style="font-size: 35px; padding: 15px; background: green;">One</div>
  <div style="font-size: 35px; padding: 15px; background: blue;">Two</div>
  <div style="font-size: 35px; padding: 15px; background: red;">Three</div>
  <div style="font-size: 35px; padding: 15px; background: magenta;">Four</div>
...
<div style="background: grey; display:flex; border:3px solid black; flex-direction:column; flex-wrap: wrap">
  <div style="font-size: 35px; padding: 15px; background: green;">One</div>
  <div style="font-size: 35px; padding: 15px; background: blue;">Two</div>
  <div style="font-size: 35px; padding: 15px; background: red;">Three</div>
  <div style="font-size: 35px; padding: 15px; background: magenta;">Four</div>
...
<div style="background: grey; display:flex; border:3px solid black; flex-direction:column; flex-wrap: wrap-reverse">
  <div style="font-size: 35px; padding: 15px; background: green;">One</div>
  <div style="font-size: 35px; padding: 15px; background: blue;">Two</div>
  <div style="font-size: 35px; padding: 15px; background: red;">Three</div>
  <div style="font-size: 35px; padding: 15px; background: magenta;">Four</div>
